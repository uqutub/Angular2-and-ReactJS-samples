...
export class AuthActions {
    ...
    login(credentials: Object): void {
        ...
        // setTimeout(() => {
        //     console.log('setTomeouttttt')
        //     this.af.auth.take(1).map(authState => {
        //         console.log('cureeent auth state ', authState)
        //           authState.auth.updateProfile({
        //             displayName: 'display name',
        //             photoURL: 'some/url'
        //           })
        //           .then((d) => console.log('after updated profile', d))
        //           .catch(err => console.log('err updated profile ', err));
        //     }).subscribe();
        // }, 5000)
    }
